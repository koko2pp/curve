...
TEST_F(TestSchedulerHelper, test_SatisfyScatterWidth_target) {
    ...
    bool target = true;
    {
        // 1. After the change, the minimum value was not reached, but it increased the scatter-width
        int oldValue = 10;
        int newValue = 13;
    ...
    {
        // 2. After the change, the minimum value is not reached, and the scatter-width remains unchanged
        int oldValue = 10;
        int newValue = 10;
    ...
    {
        // 3. After the change, the minimum value was not reached and the scatter-width decreased
        int oldValue = 10;
        int newValue = 8;
        ASSERT_FALSE(SchedulerHelper::SatisfyScatterWidth(target, oldValue,
            newValue, minScatterWidth, scatterWidthRangePerent));
    ...
    {
        // 7. After the change, it is greater than the maximum value and the scatter-width increases
    ...
    {
        // 8. After the change, it is greater than the maximum value, and the scatter-width remains unchanged
        int oldValue = maxScatterWidth + 2;
        int newValue = maxScatterWidth + 2;
        ASSERT_FALSE(SchedulerHelper::SatisfyScatterWidth(target, oldValue,
            newValue, minScatterWidth, scatterWidthRangePerent));
    ...
    {
        // 9. After the change is greater than the maximum value, the scatter-width decreases
