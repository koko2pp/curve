...
class ChunkOpRequest : public std::enable_shared_from_this<ChunkOpRequest> {
 ...
 public:
     ...
     * @param log: Output parameter to store serialized data. Users are responsible for ensuring that data != nullptr.
 ...
 protected:
    /**
     * Package the request as braft::task and propose it to the corresponding replication group
     * @param request: Chunk Request
     * @param data: The data content contained in the request
     * @return 0 succeeded, -1 failed
     */
